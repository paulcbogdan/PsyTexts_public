...
from plot_and_count.plot_Figure3C_prestige import control_vars
...
def make_journal_scatter(key, bias_adjustment=.023):
    ...
    if key == 'p_fragile':
        plt.savefig('../figs_and_tables/Figure_3B_SNIP.png', dpi=600)
    elif key == 'p_fragile_implied':
        plt.savefig('../figs_and_tables/Figure_S6B_SNIP_implied.png', dpi=600)
    plt.show()
