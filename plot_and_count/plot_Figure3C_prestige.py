...
def plot_scatter(key='p_fragile', bias_adjustment=.023):
    ...
    plt.title('University prestige ranking', fontsize=14)
    if key == 'p_fragile':
    ...
    if key == 'school_M_baye':
        plt.savefig('../figs_and_tables/Figure_S4A_corr_Baye.png', dpi=600)
    elif key == 'school_M_ML':
        plt.savefig('../figs_and_tables/Figure_S4B_corr_ML.png', dpi=600)
    elif key == 'p_fragile':
        plt.savefig('../figs_and_tables/Figure_3C_prestige.png', dpi=600)
    elif key == 'p_fragile_implied':
        plt.savefig('../figs_and_tables/Figure_S6C_prestige_p_implied.png',
                    dpi=600)
    else:
        raise ValueError
