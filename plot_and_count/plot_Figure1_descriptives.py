...
def make_p_stackplot():
    fp = r'..\dataframes\df_combined_semi_pruned_Aug24.csv'
...
def plot_university_x_research_score():
    ...
    for _, row in df_grp_both.iterrows():
        plt.plot([row['rank'], row['rank']], [0, row['research']],
                 ...
                 alpha=0.8 if row['color'] != 'red' else 0.5)
...
if __name__ == '__main__':
    ...
    plt.savefig('../figs_and_tables/Figure_1_dataset_descriptives.png', dpi=450)
    plt.show()
