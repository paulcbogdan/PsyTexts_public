...
def make_subject_df():
    ...
    with open(rf'../cache/journal_to_SCOPUS_subject_Aug24.pkl', 'rb') as f:
    ...
    fp_out = rf'../dataframes/df_subjects_Aug24.csv'
...
def make_SNIP_df():
    ...
    with open(rf'../cache/journal_to_SNIP_Aug24.pkl', 'rb') as f:
    ...
    fp_out = rf'../dataframes/df_SNIP_Aug24.csv'
