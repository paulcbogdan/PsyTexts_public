...
if __name__ == '__main__':
    ...
    make_pruned_df(r'..\dataframes\df_combined_Aug24.csv')

    # One row = one reported p-value (used for the language analysis)
    make_pruned_df(r'..\dataframes\df_by_pval_combined_Aug24.csv')

    # This one includes alternative university assignments (e.g., max or mean)
    make_pruned_df(r'..\dataframes\df_combined_all_aff_Aug24.csv')
