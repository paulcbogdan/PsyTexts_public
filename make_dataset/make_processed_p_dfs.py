...
def semi_prep(key=None):
    fp_p_by_p = fr'../dataframes/df_by_pval_Aug24.csv'
...
def make_p_processed_dfs():
    ...
    df.loc[df['cond'] == 'all_less0.05', 'p_fragile'] = .509

    fp_out_by_p = fr'../dataframes/df_p_processed_by_p_Aug24.csv'
    save_csv_pkl(df_by_p, fp_out_by_p, check_dup=False)

    fp_out = r'../dataframes/df_p_process_Aug24.csv'
